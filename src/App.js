    ...
    return (
      <div className="sm:px-2 md:px-4 lg:px-12 xl:px-12  pt-0 pb-12">
        ...
        <div className="xl:px-40 lg:px-20 md:px-8 sm:px-2">
          <div className="first">
            <h1 className="xl:px-40 xl:pb-24 pt-20 pb-8 xl:text-5xl lg:text-4xl md:text-3xl sm:text-2xl text-xl font-mono w-11/12 mx-auto">divulge your identity to the ai</h1>
          ...
          <div className="second">
            <h1 className="xl:px-40 pt-40  xl:text-5xl lg:text-4xl md:text-3xl sm:text-2xl text-xl font-mono w-11/12 mx-auto">secure your likes, ratings, comments</h1>
            <h1 className="xl:px-40 xl:pb-24 pb-8  xl:text-5xl lg:text-4xl md:text-3xl sm:text-2xl text-xl font-mono w-11/12 mx-auto">& discover people with similar tastes</h1>
          ...
          <div className="third">
            <h1 className="xl:px-40 pt-40  xl:text-5xl lg:text-4xl md:text-3xl sm:text-2xl text-xl font-mono w-11/12 mx-auto">authenticate with Filecoin or Ethereum</h1>
            <h1 className="xl:px-40 xl:pb-24 pb-8  xl:text-5xl lg:text-4xl md:text-3xl sm:text-2xl text-xl font-mono w-11/12 mx-auto">for instant personalization</h1>
            <img src={twitter} alt="better twitter" className="w-11/12 mx-auto" />
          </div>
          <div className="fourth">
            <h1 className="xl:px-40 pt-40  xl:text-5xl lg:text-4xl md:text-3xl sm:text-2xl text-xl font-mono w-11/12 mx-auto">and social context</h1>
            <h1 className="xl:px-40 xl:pb-24 pb-8  xl:text-5xl lg:text-4xl md:text-3xl sm:text-2xl text-xl font-mono w-11/12 mx-auto">anywhere</h1>
